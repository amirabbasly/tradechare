...
function botReply(q: string): { text: string; action?: "contact" } {
  ...
  if (/(هزینه|قیمت|کارمزد|نرخ‌نامه|چقدر)/.test(t))
    return { text: "کارمزد ترخیص ما از ۰.۸٪ ارزش CIF شروع میشه و استعلام تعرفه + مشاوره اول کاملاً رایگانه. 💡 اگه نوع کالا و گمرک مقصد رو بگید، پیش‌فاکتور دقیق صادر می‌کنم. برای صدور پیش‌فاکتور رسمی، تماس با کارشناس رو پیشنهاد می‌کنم.", action: "contact" };
  if (/(دلار|درهم|ارز|تتر|یورو|نرخ امروز)/.test(t))
    return { text: "📊 آخرین نرخ‌های تابلو تریدچاره:\n• دلار آزاد: ۱۰۴٬۲۰۰ تومان\n• درهم امارات: ۲۸٬۳۷۰ تومان\n• تتر: ۱۰۳٬۹۵۰ تومان\nتحلیل چاره‌بات: روند بازار صعودی ملایمه؛ برای خریدهای بالای ۵۰ هزار دلار، خرید پلکانی پیشنهاد میشه." };
